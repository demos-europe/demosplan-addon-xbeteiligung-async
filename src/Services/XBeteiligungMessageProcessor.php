...
class XBeteiligungMessageProcessor
{
    ...
    /**
     * Process incoming messages and return response data for each message.
     *
     * @return array Array of response data for sending back to RabbitMQ
     */
    public function processIncomingMessages(array $messages): array
    {
        $responses = [];
