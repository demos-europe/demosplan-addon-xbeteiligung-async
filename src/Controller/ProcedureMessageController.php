...
class ProcedureMessageController extends APIController
{
     ...
     * token stored in `addon_xbeteiligung_async_xbeteiligung_api_token`.
     */
    ...
    public function showNewImportableProcedureMessages(
        ...
        if ($request->headers->get('authToken') !== $this->getParameter('addon_xbeteiligung_async_xbeteiligung_api_token')) {
    ...
    {
        return $authToken !== $this->getParameter('addon_xbeteiligung_async_xbeteiligung_api_token');
    }
}
