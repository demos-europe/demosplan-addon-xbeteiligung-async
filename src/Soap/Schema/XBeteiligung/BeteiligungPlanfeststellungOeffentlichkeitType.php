...
/**
 * Class representing BeteiligungPlanfeststellungOeffentlichkeitType
 *
 * Dieser Datentyp enthält alle Informationen zu einem Beteiligungsverfahren im Rahmen der kommunalen Bauleitplanung.
 * XSD Type: BeteiligungPlanfeststellungOeffentlichkeit
 */
class BeteiligungPlanfeststellungOeffentlichkeitType
{
    /**
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungPlanfeststellungOeffentlichkeitType\BeteiligungPlanfeststellungOeffentlichkeitArtAnonymousPHPType $beteiligungPlanfeststellungOeffentlichkeitArt
     */
    private $beteiligungPlanfeststellungOeffentlichkeitArt = null;
    ...
    /**
     * Gets as beteiligungPlanfeststellungOeffentlichkeitArt
     *
     * Hier ist zu übermitteln, um welche Art der Öffentlichkeitsbeteiligung es sich handelt.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungPlanfeststellungOeffentlichkeitType\BeteiligungPlanfeststellungOeffentlichkeitArtAnonymousPHPType
     */
    public function getBeteiligungPlanfeststellungOeffentlichkeitArt()
    {
        return $this->beteiligungPlanfeststellungOeffentlichkeitArt;
    }

    /**
     * Sets a new beteiligungPlanfeststellungOeffentlichkeitArt
     *
     * Hier ist zu übermitteln, um welche Art der Öffentlichkeitsbeteiligung es sich handelt.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungPlanfeststellungOeffentlichkeitType\BeteiligungPlanfeststellungOeffentlichkeitArtAnonymousPHPType $beteiligungPlanfeststellungOeffentlichkeitArt
     * @return self
     */
    public function setBeteiligungPlanfeststellungOeffentlichkeitArt(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungPlanfeststellungOeffentlichkeitType\BeteiligungPlanfeststellungOeffentlichkeitArtAnonymousPHPType $beteiligungPlanfeststellungOeffentlichkeitArt)
    {
        $this->beteiligungPlanfeststellungOeffentlichkeitArt = $beteiligungPlanfeststellungOeffentlichkeitArt;
        return $this;
    }
