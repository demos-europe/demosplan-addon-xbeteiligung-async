 ...
 *
 * Der Datentyp benennt Akteure des Vorhabens, für das eine Beteiligung initiert wird. Der Veranlasser ist immer zu benennen, weitere Akteure können mit ihrer Rolle übermittelt werden.
...
class AkteurVorhabenType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\OrganisationType $veranlasser
     */
     ...
     * Hier wird Behörde oder Stelle genannt, die für das Verfahren rechtlich verantwortlich ist.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\OrganisationType $veranlasser
     * @return self
     */
    public function setVeranlasser(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\OrganisationType $veranlasser)
    {
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\AkteurVorhabenType\WeitereAkteureAnonymousPHPType $weitereAkteure
     */
    public function addToWeitereAkteure(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\AkteurVorhabenType\WeitereAkteureAnonymousPHPType $weitereAkteure)
    {
     ...
     * Dieser Abschnitt fasst die Daten zu einem weiteren Akteur zusammen. Für jeden Akteur ist ein Element zu instanziieren.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\AkteurVorhabenType\WeitereAkteureAnonymousPHPType[]
     */
