...
/**
 * Class representing BeteiligungPlanfeststellungTOEBType
 *
 * Dieser Datentyp enthält alle Informationen zu einem Beteiligungsverfahren im Rahmen der kommunalen Bauleitplanung.
 * XSD Type: BeteiligungPlanfeststellungTOEB
 */
class BeteiligungPlanfeststellungTOEBType
{
    /**
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungPlanfeststellungTOEBType\BeteiligungPlanfeststellungTOEBArtAnonymousPHPType $beteiligungPlanfeststellungTOEBArt
     */
    private $beteiligungPlanfeststellungTOEBArt = null;
    ...
    /**
     * Gets as beteiligungPlanfeststellungTOEBArt
     *
     * Hier ist zu übermitteln, um welche Art der Beteiligung der Träger öffentlicher Belange es sich handelt.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungPlanfeststellungTOEBType\BeteiligungPlanfeststellungTOEBArtAnonymousPHPType
     */
    public function getBeteiligungPlanfeststellungTOEBArt()
    {
        return $this->beteiligungPlanfeststellungTOEBArt;
    }

    /**
     * Sets a new beteiligungPlanfeststellungTOEBArt
     *
     * Hier ist zu übermitteln, um welche Art der Beteiligung der Träger öffentlicher Belange es sich handelt.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungPlanfeststellungTOEBType\BeteiligungPlanfeststellungTOEBArtAnonymousPHPType $beteiligungPlanfeststellungTOEBArt
     * @return self
     */
    public function setBeteiligungPlanfeststellungTOEBArt(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungPlanfeststellungTOEBType\BeteiligungPlanfeststellungTOEBArtAnonymousPHPType $beteiligungPlanfeststellungTOEBArt)
    {
        $this->beteiligungPlanfeststellungTOEBArt = $beteiligungPlanfeststellungTOEBArt;
        return $this;
    }
