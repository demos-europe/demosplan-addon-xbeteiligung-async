...
class StellungnahmeType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeStatusDerStellungnahmeType $status
     */
    private $status = null;
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\VerfasserType $verfasser
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeArtDerStellungnahmeType $artDerStellungnahme
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeArtDerRueckmeldungType $artDerRueckmeldung
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeVerfahrensteilschrittType $verfahrensteilschritt
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\ZuordnungType[] $zuordnung
     */
    private $zuordnung = [
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\GeoreferenzierungType[] $georeferenzierung
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodePrioritaetDerStellungnahmeType $prioritaet
     */
     ...
     * Hier ist der Status der Stellungsnahme zu übermitteln.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeStatusDerStellungnahmeType
     */
     ...
     * Hier ist der Status der Stellungsnahme zu übermitteln.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeStatusDerStellungnahmeType $status
     * @return self
     */
    public function setStatus(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeStatusDerStellungnahmeType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * Für die Stellungnahme verantwortliche Organisation bzw. Behörde.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\VerfasserType
     */
     ...
     * Für die Stellungnahme verantwortliche Organisation bzw. Behörde.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\VerfasserType $verfasser
     * @return self
     */
    public function setVerfasser(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\VerfasserType $verfasser = null)
    {
     ...
     * Hier ist die Art der Stellungnahme zu übermitteln.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeArtDerStellungnahmeType
     */
     ...
     * Hier ist die Art der Stellungnahme zu übermitteln.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeArtDerStellungnahmeType $artDerStellungnahme
     * @return self
     */
    public function setArtDerStellungnahme(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeArtDerStellungnahmeType $artDerStellungnahme = null)
    {
     ...
     * Hier ist die Art der Rückmeldung zu übermitteln.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeArtDerRueckmeldungType
     */
     ...
     * Hier ist die Art der Rückmeldung zu übermitteln.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeArtDerRueckmeldungType $artDerRueckmeldung
     * @return self
     */
    public function setArtDerRueckmeldung(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeArtDerRueckmeldungType $artDerRueckmeldung = null)
    {
     ...
     * Hier ist der Verfahrensteilschritt zu übermitteln, zu dem die Stellungnahme abgegeben wurde.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeVerfahrensteilschrittType $verfahrensteilschritt
     * @return self
     */
    public function setVerfahrensteilschritt(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeVerfahrensteilschrittType $verfahrensteilschritt)
    {
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\ZuordnungType $zuordnung
     */
    public function addToZuordnung(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\ZuordnungType $zuordnung)
    {
     ...
     * Hier kann die Zuordnung zum Gegenstand der Stellungnahme erfolgen.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\ZuordnungType[]
     */
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\GeoreferenzierungType $georeferenzierung
     */
    public function addToGeoreferenzierung(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\GeoreferenzierungType $georeferenzierung)
    {
     ...
     * Hier können Georeferenzierungen übermittelt werden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\GeoreferenzierungType[]
     */
     ...
     * Hier kann die Priorität der Stellungnahme übermittelt werden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodePrioritaetDerStellungnahmeType
     */
     ...
     * Hier kann die Priorität der Stellungnahme übermittelt werden.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodePrioritaetDerStellungnahmeType $prioritaet
     * @return self
     */
    public function setPrioritaet(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodePrioritaetDerStellungnahmeType $prioritaet = null)
    {
