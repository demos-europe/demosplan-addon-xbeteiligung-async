...
namespace DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\RaumordnungInformationAktualisiertOK0362;

use DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Basisnachricht\G2g\NachrichtG2GTypeType;

/**
 * Class representing RaumordnungInformationAktualisiertOK0362AnonymousPHPType
 */
class RaumordnungInformationAktualisiertOK0362AnonymousPHPType extends NachrichtG2GTypeType
{
    /**
