...
namespace DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\AllgemeinStellungnahmeGeloescht0709\AllgemeinStellungnahmeGeloescht0709AnonymousPHPType;
...
class NachrichteninhaltAnonymousPHPType
{
    ...
    /**
     * Stellungnahme-ID, die in der Nachricht 0701/0702 übermittelt wurde.
     *
    ...
    /**
     * Die Plan-ID, die in der Nachricht 0201, 0301 oder 0401 übermittelt wurde.
     *
     * @var string $planID
     */
    private $planID = null;
