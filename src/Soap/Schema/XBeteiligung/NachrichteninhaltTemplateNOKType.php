...
class NachrichteninhaltTemplateNOKType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\FehlerType[] $fehler
     */
    private $fehler = [
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\FehlerhafteUnterlageType[] $fehlerhafteUnterlagen
     */
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\FehlerType $fehler
     */
    public function addToFehler(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\FehlerType $fehler)
    {
        $this->fehler[] = $fehler;
        return $this;
    }
     ...
     * Hier kann die Beschreibung des Fehlers übermittelt werden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\FehlerType[]
     */
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\FehlerhafteUnterlageType $fehlerhafteUnterlagen
     */
    public function addToFehlerhafteUnterlagen(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\FehlerhafteUnterlageType $fehlerhafteUnterlagen)
    {
     ...
     * In diesem Element können fehlerhafte Planungsunterlagen beschrieben werden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\FehlerhafteUnterlageType[]
     */
