...
/**
 * Class representing CodeBeteiligungPlanfeststellungInformellOeffentlichkeitType
 *
 * Hier kann die Art des informellen Verfahrens zur Beteiligung der Öffentlichkeit übermittelt werden.
 * XSD Type: Code.BeteiligungPlanfeststellungInformellOeffentlichkeit
 */
class CodeBeteiligungPlanfeststellungInformellOeffentlichkeitType extends CodeType
{
}
