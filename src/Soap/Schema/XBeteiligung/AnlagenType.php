...
class AnlagenType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\MetadatenAnlageType[] $anlage
     */
    private $anlage = [
     ...
     */
    public function addToAnlage(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\MetadatenAnlageType $anlage)
    {
        $this->anlage[] = $anlage;
        return $this;
    }
