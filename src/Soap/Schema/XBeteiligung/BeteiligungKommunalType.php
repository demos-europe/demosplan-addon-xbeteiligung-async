...
class BeteiligungKommunalType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodePlanartKommunalType $planartKommunal
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungKommunalOeffentlichkeitType $beteiligungOeffentlichkeit
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungKommunalTOEBType $beteiligungTOEB
     */
     ...
     * Hier kann die Art des Planverfahrens übermittelt werden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodePlanartKommunalType
     */
     ...
     * Hier kann die Art des Planverfahrens übermittelt werden.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodePlanartKommunalType $planartKommunal
     * @return self
     */
    public function setPlanartKommunal(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodePlanartKommunalType $planartKommunal = null)
    {
     ...
     * Hier kann die Art des Beteiligungsverfahrens übermittelt werden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeVerfahrensartKommunalType
     */
     ...
     * Hier kann die Art des Beteiligungsverfahrens übermittelt werden.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeVerfahrensartKommunalType $verfahrensartKommunal
     * @return self
     */
    public function setVerfahrensartKommunal(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\CodeVerfahrensartKommunalType $verfahrensartKommunal = null)
    {
     ...
     * Hier können Angaben zur Beteiligung der Öffentlichkeit gemacht werden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungKommunalOeffentlichkeitType
     */
     ...
     * Hier können Angaben zur Beteiligung der Öffentlichkeit gemacht werden.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungKommunalOeffentlichkeitType $beteiligungOeffentlichkeit
     * @return self
     */
    public function setBeteiligungOeffentlichkeit(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungKommunalOeffentlichkeitType $beteiligungOeffentlichkeit = null)
    {
     ...
     * Hier können Angaben zur Beteiligung der Träger öffentlicher Belange gemacht werden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungKommunalTOEBType
     */
     ...
     * Hier können Angaben zur Beteiligung der Träger öffentlicher Belange gemacht werden.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungKommunalTOEBType $beteiligungTOEB
     * @return self
     */
    public function setBeteiligungTOEB(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\XBeteiligung\BeteiligungKommunalTOEBType $beteiligungTOEB = null)
    {
