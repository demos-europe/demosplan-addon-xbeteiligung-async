...
class AnhangOderVerlinkungType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\MetadatenAnhangType $anhang
     */
    private $anhang = null;
     ...
     * Das Dokument wird als Anhang mit dieser XBau-Fachnachricht übertragen. Dazu stehen unterhalb dieses Elements die passenden Metadaten .
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\MetadatenAnhangType
     */
     ...
     * Das Dokument wird als Anhang mit dieser XBau-Fachnachricht übertragen. Dazu stehen unterhalb dieses Elements die passenden Metadaten .
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\MetadatenAnhangType $anhang
     * @return self
     */
    public function setAnhang(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\MetadatenAnhangType $anhang = null)
    {
        $this->anhang = $anhang;
        return $this;
    }
