...
class GeoreferenzierteLinieType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\GeoreferenzierteLinieType\LinieAnonymousPHPType[] $linie
     */
    private $linie = [
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\GeoreferenzierteLinieType\LinieAnonymousPHPType $linie
     */
    public function addToLinie(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\GeoreferenzierteLinieType\LinieAnonymousPHPType $linie)
    {
        $this->linie[] = $linie;
        return $this;
    }
     ...
     * In diesem Element lassen sich georeferenzierte Daten zu linienförmigen Elementen übermitteln, z. B. die Lage einer geplanten Breitbandtrasse.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\GeoreferenzierteLinieType\LinieAnonymousPHPType[]
     */
