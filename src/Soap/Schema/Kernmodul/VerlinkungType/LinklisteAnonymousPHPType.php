...
namespace DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\VerlinkungType;
...
class LinklisteAnonymousPHPType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\VerlinkungType\LinklisteAnonymousPHPType\LinkAnonymousPHPType[] $link
     */
    private $link = [
     ...
     */
    public function addToLink(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\VerlinkungType\LinklisteAnonymousPHPType\LinkAnonymousPHPType $link)
    {
        $this->link[] = $link;
        return $this;
    }
