...
/**
 * Class representing NachrichtG2GType
 *
 * Nachrichtenstruktur für die Kommunikation von Behörden (bzw. öffentlichen Stellen oder Diensten) mit anderen Behörden (bzw. öffentlichen Stellen oder Diensten).
 * XSD Type: Nachricht.G2G
 */
class NachrichtG2GType extends NachrichtG2GTypeType
{
    /**
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\NachrichtenkopfG2GType $nachrichtenkopfG2g
     */
     ...
     * Dieses Element enthält die Kopfinformationen zu Nachrichten des vorliegenden Typs.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\NachrichtenkopfG2GType
     */
     ...
     * Dieses Element enthält die Kopfinformationen zu Nachrichten des vorliegenden Typs.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\NachrichtenkopfG2GType $nachrichtenkopfG2g
     * @return self
     */
    public function setNachrichtenkopfG2g(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\NachrichtenkopfG2GType $nachrichtenkopfG2g)
    {
