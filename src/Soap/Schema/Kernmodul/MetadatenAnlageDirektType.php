...
/**
 * Class representing MetadatenAnlageDirektType
 *
 * Dieser Typ nimmt die Metadaten zu einer Bauvorlage bzw. sonstigen Anlage auf, die gemäß der Architektur der Übertragung von Primärdokumenten im Zusammenhang mit einer XBau-Fachnachricht benötigt werden.
 * XSD Type: MetadatenAnlageDirekt
 */
class MetadatenAnlageDirektType
{
    /**
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\CodeAnlageArtType $anlageart
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\AnhangOderVerlinkungType $anhangOderVerlinkung
     */
     ...
     * Unterhalb dieses Elements wird die Art dieser Bauvorlage oder sonstigen Anlage näher spezifiziert.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\CodeAnlageArtType
     */
     ...
     * Unterhalb dieses Elements wird die Art dieser Bauvorlage oder sonstigen Anlage näher spezifiziert.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\CodeAnlageArtType $anlageart
     * @return self
     */
    public function setAnlageart(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\CodeAnlageArtType $anlageart)
    {
     ...
     * Eine Instanz dieses Elements enthält passende Metadaten zur Bauvorlage bzw. sonstigen Anlage, je nachdem ob diese (i) als Anhang mit dieser XBau-Nachricht übermittelt wird oder ob sie (ii) über einen Link zugänglich gemacht wird, der in diese XBau-Nachricht eingetragen ist.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\AnhangOderVerlinkungType
     */
     ...
     * Eine Instanz dieses Elements enthält passende Metadaten zur Bauvorlage bzw. sonstigen Anlage, je nachdem ob diese (i) als Anhang mit dieser XBau-Nachricht übermittelt wird oder ob sie (ii) über einen Link zugänglich gemacht wird, der in diese XBau-Nachricht eingetragen ist.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\AnhangOderVerlinkungType $anhangOderVerlinkung
     * @return self
     */
    public function setAnhangOderVerlinkung(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\AnhangOderVerlinkungType $anhangOderVerlinkung)
    {
