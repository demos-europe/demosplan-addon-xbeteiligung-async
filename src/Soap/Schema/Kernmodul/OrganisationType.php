...
class OrganisationType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\NameOrganisationType $name
     */
    private $name = null;
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\NameNatuerlichePersonType[] $vertreter
     */
    private $vertreter = [
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\OrganisationType\AnsprechpartnerAnonymousPHPType[] $ansprechpartner
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\RegistereintragType $registereintrag
     */
     ...
     * Angaben zum offiziellen Namen der Organisation.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\NameOrganisationType
     */
     ...
     * Angaben zum offiziellen Namen der Organisation.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\NameOrganisationType $name
     * @return self
     */
    public function setName(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\NameOrganisationType $name)
    {
        $this->name = $name;
        return $this;
    }
     ...
     */
    public function addToAnschrift(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\AnschriftType $anschrift)
    {
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\NameNatuerlichePersonType $vertreter
     */
    public function addToVertreter(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\NameNatuerlichePersonType $vertreter)
    {
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\OrganisationType\AnsprechpartnerAnonymousPHPType $ansprechpartner
     */
    public function addToAnsprechpartner(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\OrganisationType\AnsprechpartnerAnonymousPHPType $ansprechpartner)
    {
     ...
     * Pro Instanz dieses Elements kann eine Angabe zu einer Person als operativer Ansprechpartner für die Organisation übermittelt werden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\OrganisationType\AnsprechpartnerAnonymousPHPType[]
     */
     ...
     * Angaben zum Registereintrag einer natürlichen oder juristischen Person oder Personengesellschaft.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\RegistereintragType
     */
     ...
     * Angaben zum Registereintrag einer natürlichen oder juristischen Person oder Personengesellschaft.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\RegistereintragType $registereintrag
     * @return self
     */
    public function setRegistereintrag(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\RegistereintragType $registereintrag = null)
    {
