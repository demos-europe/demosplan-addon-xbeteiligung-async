...
class AnbindungFachverfahrenType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\AnwendungsspezifischeErweiterungXMLType $anwendungsspezifischeErweiterung
     */
     ...
     * Über AnwendungsspezifischeErweiterung können über die in XBau konkret definierten Metadaten hinaus weiterführende Metadaten, z. B. fachspezifischer Natur, zu einem Informationsobjekt angegeben werden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\AnwendungsspezifischeErweiterungXMLType
     */
     ...
     * Über AnwendungsspezifischeErweiterung können über die in XBau konkret definierten Metadaten hinaus weiterführende Metadaten, z. B. fachspezifischer Natur, zu einem Informationsobjekt angegeben werden.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\AnwendungsspezifischeErweiterungXMLType $anwendungsspezifischeErweiterung
     * @return self
     */
    public function setAnwendungsspezifischeErweiterung(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\AnwendungsspezifischeErweiterungXMLType $anwendungsspezifischeErweiterung = null)
    {
