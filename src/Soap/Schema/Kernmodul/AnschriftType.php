...
class AnschriftType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\StaatType $staat
     */
    private $staat = null;
     ...
     * Der Staat, dem die Anschrift postalisch zugeordnet wird.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\StaatType
     */
     ...
     * Der Staat, dem die Anschrift postalisch zugeordnet wird.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\StaatType $staat
     * @return self
     */
    public function setStaat(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\StaatType $staat = null)
    {
        $this->staat = $staat;
        return $this;
    }
