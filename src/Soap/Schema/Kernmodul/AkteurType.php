...
class AkteurType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\AmBauBeteiligtePersonType $natuerlichePerson
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\OrganisationType $organisation
     */
     ...
     * In dieses Element sind die Angaben zu der natürlichen Person einzutragen.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\AmBauBeteiligtePersonType
     */
     ...
     * In dieses Element sind die Angaben zu der natürlichen Person einzutragen.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\AmBauBeteiligtePersonType $natuerlichePerson
     * @return self
     */
    public function setNatuerlichePerson(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\AmBauBeteiligtePersonType $natuerlichePerson = null)
    {
     ...
     * In dieses Element sind die Angaben zu der Organisation einzutragen.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\OrganisationType $organisation
     * @return self
     */
    public function setOrganisation(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\OrganisationType $organisation = null)
    {
