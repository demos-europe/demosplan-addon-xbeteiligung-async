...
/**
 * Class representing TextFormatiertType
 *
 ...
 * XSD Type: TextFormatiert
 */
class TextFormatiertType
{
    /**
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\TextFormatiertType\TextOfficeAnonymousPHPType $textOffice
     */
     ...
     * Unterhalb dieses Elements kann derselbe Inhalt wie im Element text in einem alternativen technischen Format angeboten werden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\TextFormatiertType\TextOfficeAnonymousPHPType
     */
     ...
     * Unterhalb dieses Elements kann derselbe Inhalt wie im Element text in einem alternativen technischen Format angeboten werden.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\TextFormatiertType\TextOfficeAnonymousPHPType $textOffice
     * @return self
     */
    public function setTextOffice(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\TextFormatiertType\TextOfficeAnonymousPHPType $textOffice = null)
    {
