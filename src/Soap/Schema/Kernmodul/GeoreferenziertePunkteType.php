...
class GeoreferenziertePunkteType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\GeoreferenziertePunkteType\PunktAnonymousPHPType[] $punkt
     */
    private $punkt = [
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\GeoreferenziertePunkteType\PunktAnonymousPHPType $punkt
     */
    public function addToPunkt(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\GeoreferenziertePunkteType\PunktAnonymousPHPType $punkt)
    {
        $this->punkt[] = $punkt;
        return $this;
    }
     ...
     * In diesem Element lassen sich georeferenzierte Daten zur punktförmigen Elementen übermitteln, z. B. die Lage von Schaltkästen, Schächten oder Baugruben.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Kernmodul\GeoreferenziertePunkteType\PunktAnonymousPHPType[]
     */
