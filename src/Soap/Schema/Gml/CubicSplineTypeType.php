...
class CubicSplineTypeType extends AbstractCurveSegmentTypeType
{
    ...
    /**
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Gml\VectorTypeType $vectorAtStart
     */
    private $vectorAtStart = null;

    /**
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Gml\VectorTypeType $vectorAtEnd
     */
     ...
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Gml\VectorTypeType
     */
     ...
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Gml\VectorTypeType $vectorAtStart
     * @return self
     */
    public function setVectorAtStart(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Gml\VectorTypeType $vectorAtStart)
    {
     ...
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Gml\VectorTypeType $vectorAtEnd
     * @return self
     */
    public function setVectorAtEnd(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Gml\VectorTypeType $vectorAtEnd)
    {
