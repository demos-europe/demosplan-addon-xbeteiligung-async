...
{
    /**
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Gml\AbstractSurfacePatch[] $patches
     */
     ...
     */
    public function addToPatches(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Gml\AbstractSurfacePatch $abstractSurfacePatch)
    {
     ...
     * Sets a new patches
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\Schema\Gml\AbstractSurfacePatch[] $patches
     * @return self
     */
