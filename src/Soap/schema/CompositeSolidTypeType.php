...
class CompositeSolidTypeType extends AbstractSolidTypeType
{
    ...
    /**
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\SolidMember[] $solidMember
     */
    private $solidMember = [
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\SolidMember $solidMember
     */
    public function addToSolidMember(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\SolidMember $solidMember)
    {
     ...
     * Gets as solidMember
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\SolidMember[]
     */
