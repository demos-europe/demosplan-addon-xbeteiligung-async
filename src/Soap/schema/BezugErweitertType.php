...
class BezugErweitertType extends BezugType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\AnbindungFachverfahrenType $anbindungFachverfahren
     */
     ...
     * Dieses Element kann verwendet werden, um die behördliche Fachanwendung an das Antragsportal oder die Kollaborationsplattform anzubinden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\AnbindungFachverfahrenType
     */
     ...
     * Dieses Element kann verwendet werden, um die behördliche Fachanwendung an das Antragsportal oder die Kollaborationsplattform anzubinden.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\AnbindungFachverfahrenType $anbindungFachverfahren
     * @return self
     */
    public function setAnbindungFachverfahren(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\AnbindungFachverfahrenType $anbindungFachverfahren = null)
    {
