...
class VerfasserType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\NameNatuerlichePersonType $name
     */
    private $name = null;
     ...
     * Hier ist der Name der Person anzugeben, die die Stellungnahme als Privatperson oder im Namen einer Organisation verfasst.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\NameNatuerlichePersonType $name
     * @return self
     */
    public function setName(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\NameNatuerlichePersonType $name)
    {
        $this->name = $name;
        return $this;
    }
     ...
     * @return self
     */
    public function setAnschrift(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\AnschriftType $anschrift = null)
    {
