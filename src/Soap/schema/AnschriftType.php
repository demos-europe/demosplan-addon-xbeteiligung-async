...
class AnschriftType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\StaatType $staat
     */
    private $staat = null;
     ...
     * Der Staat, dem die Anschrift postalisch zugeordnet wird.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\StaatType
     */
     ...
     * Der Staat, dem die Anschrift postalisch zugeordnet wird.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\StaatType $staat
     * @return self
     */
    public function setStaat(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\StaatType $staat = null)
    {
        $this->staat = $staat;
        return $this;
    }
