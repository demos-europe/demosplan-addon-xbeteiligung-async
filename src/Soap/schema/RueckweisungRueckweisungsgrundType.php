...
/**
 * Class representing RueckweisungRueckweisungsgrundType
 *
 ...
 * XSD Type: Rueckweisung.Rueckweisungsgrund
 */
class RueckweisungRueckweisungsgrundType
{
    /**
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFehlercodeXInneresType $grund
     */
    private $grund = null;
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungGrundSpezifischType[] $grundSpezifisch
     */
     ...
     * Mit diesem Element wird ein Grund übermittelt, aus dem die Nachricht zurückgewiesen wird. Die im Rahmen der hier zu verwendenden Schlüsseltabelle zur Verfügung gestellten Rückweisungsgründe sind kontextunabhängig und finden daher in allen xinneres-fachmodulen Anwendung. Sofern der Schlüssel S999 verwendet wird, sind ergänzende Angaben in dem Element grundSpezifisch verpflichtend zu übermitteln.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFehlercodeXInneresType
     */
     ...
     * Mit diesem Element wird ein Grund übermittelt, aus dem die Nachricht zurückgewiesen wird. Die im Rahmen der hier zu verwendenden Schlüsseltabelle zur Verfügung gestellten Rückweisungsgründe sind kontextunabhängig und finden daher in allen xinneres-fachmodulen Anwendung. Sofern der Schlüssel S999 verwendet wird, sind ergänzende Angaben in dem Element grundSpezifisch verpflichtend zu übermitteln.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFehlercodeXInneresType $grund
     * @return self
     */
    public function setGrund(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFehlercodeXInneresType $grund)
    {
        $this->grund = $grund;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungGrundSpezifischType $grundSpezifisch
     */
    public function addToGrundSpezifisch(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungGrundSpezifischType $grundSpezifisch)
    {
     ...
     * In diesem Element können weitere - im Allgemeinen kontextspezifische Angaben - zu dem Grund übermittelt werden, aus dem die Nachricht zurückgewiesen wird.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungGrundSpezifischType[]
     */
