...
/**
 * Class representing VerfahrensverweisTypeType
 *
 *
 * XSD Type: VerfahrensverweisType
 */
class VerfahrensverweisTypeType
{
    /**
     * @var string $planID
     */
     ...
     * @return self
     */
    public function setVerfahrenstyp(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeVerfahrenstypTypeType $verfahrenstyp)
    {
     ...
     * @return self
     */
    public function setVerfahrensart(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeVerfahrensartTypeType $verfahrensart)
    {
