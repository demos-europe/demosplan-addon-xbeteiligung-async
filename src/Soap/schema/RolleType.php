...
class RolleType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeRolleType $code
     */
    private $code = null;
     ...
     * Angabe der Rolle des Beteiligten.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeRolleType
     */
     ...
     * Angabe der Rolle des Beteiligten.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeRolleType $code
     * @return self
     */
    public function setCode(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeRolleType $code = null)
    {
        $this->code = $code;
        return $this;
    }
