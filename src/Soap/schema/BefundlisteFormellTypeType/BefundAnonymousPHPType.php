...
namespace DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\BefundlisteFormellTypeType;
...
class BefundAnonymousPHPType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFormelleBefundeArtTypeType $artDesBefundes
     */
     ...
     * In diesem Element wird die Befundkategorie angegeben, der dieser Befund zugeordnet werden kann.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFormelleBefundeArtTypeType
     */
     ...
     * In diesem Element wird die Befundkategorie angegeben, der dieser Befund zugeordnet werden kann.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFormelleBefundeArtTypeType $artDesBefundes
     * @return self
     */
    public function setArtDesBefundes(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFormelleBefundeArtTypeType $artDesBefundes)
    {
