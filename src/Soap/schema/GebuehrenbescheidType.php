...
class GebuehrenbescheidType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\KostenberechnungType $kostenberechnung
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\ZahlungsdatenType $zahlungsdaten
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\MetadatenAnlageDirektType[] $anlage
     */
    private $anlage = null;
     ...
     * Dieses Objekt enthält alle Informationen zu den Positionen des Gebührenbescheids und deren Summierung zu einem Geldbetrag.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\KostenberechnungType
     */
     ...
     * Dieses Objekt enthält alle Informationen zu den Positionen des Gebührenbescheids und deren Summierung zu einem Geldbetrag.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\KostenberechnungType $kostenberechnung
     * @return self
     */
    public function setKostenberechnung(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\KostenberechnungType $kostenberechnung = null)
    {
     ...
     * Dieses Element enthält die Angaben, die der Anwender zur Veranlassung einer bargeldlosen Bezahlung gemäß SEPA benötigt.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\ZahlungsdatenType
     */
     ...
     * Dieses Element enthält die Angaben, die der Anwender zur Veranlassung einer bargeldlosen Bezahlung gemäß SEPA benötigt.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\ZahlungsdatenType $zahlungsdaten
     * @return self
     */
    public function setZahlungsdaten(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\ZahlungsdatenType $zahlungsdaten = null)
    {
     ...
     */
    public function addToAnlage(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\MetadatenAnlageDirektType $anlage)
    {
        $this->anlage[] = $anlage;
        return $this;
    }
