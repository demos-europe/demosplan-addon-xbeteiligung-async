...
/**
 * Class representing RueckweisungTransportinformationenTypeType
 *
 * Mit diesem Typ können Angaben zu den Transportinformationen der zurückgewiesenen Nachricht übermittelt werden.
 * XSD Type: Rueckweisung.TransportinformationenType
 */
class RueckweisungTransportinformationenTypeType
{
    /**
