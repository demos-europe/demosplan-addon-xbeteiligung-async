...
/**
 * Class representing RueckweisungTemplateTypeType
 *
 * Dieser Typ realisiert die abstrakte Oberklasse aller Rückweisungscontainer.
 * XSD Type: Rueckweisung.TemplateType
 */
class RueckweisungTemplateTypeType
{
    /**
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungRueckweisendeStelleTypeType $rueckweisendeStelle
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungRueckweisungsgrundTypeType[] $rueckweisungsgrund
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungTransportinformationenTypeType $transportinformationen
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungEinzelfallTypeType[] $nichtVerarbeitbarerEinzelfall
     */
     ...
     * Dieses Kindelement ist nur dann zu übermitteln, wenn die Nachricht nicht von dem ursprünglich adressierten Leser zurückgesandt wird, sondern von einer anderen Stelle (zum Beispiel einer Clearingstelle, die im Auftrag der ursprünglich adressierten Behörde eine Prüfung eingehender Nachrichten nach formalen Kriterien durchführt). Wird dieses Element nicht übermittelt, ist die rückweisende Stelle der zurückgewiesenen Nachricht (Kindelement nachricht) zu entnehmen.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungRueckweisendeStelleTypeType
     */
     ...
     * Dieses Kindelement ist nur dann zu übermitteln, wenn die Nachricht nicht von dem ursprünglich adressierten Leser zurückgesandt wird, sondern von einer anderen Stelle (zum Beispiel einer Clearingstelle, die im Auftrag der ursprünglich adressierten Behörde eine Prüfung eingehender Nachrichten nach formalen Kriterien durchführt). Wird dieses Element nicht übermittelt, ist die rückweisende Stelle der zurückgewiesenen Nachricht (Kindelement nachricht) zu entnehmen.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungRueckweisendeStelleTypeType $rueckweisendeStelle
     * @return self
     */
    public function setRueckweisendeStelle(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungRueckweisendeStelleTypeType $rueckweisendeStelle = null)
    {
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungRueckweisungsgrundTypeType $rueckweisungsgrund
     */
    public function addToRueckweisungsgrund(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungRueckweisungsgrundTypeType $rueckweisungsgrund)
    {
     ...
     * In diesem Element sind Informationen zu übermitteln, die bei dem Empfang einer als fehlerhaft betrachteten Nachricht möglicherweise der Transportebene entnommen werden konnten. Diese Angaben können gemacht werden, um dem Leser oder Empfänger einer Rücksendenachricht die Identifikation der als fehlerhaft betrachteten und nunmehr zurückgesandten Nachricht zu erleichtern. Alle Kindelemente dieses Elementes sind optional, da keine verbindlichen Anforderungen an das Transportprotokoll gestellt werden können.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungTransportinformationenTypeType
     */
     ...
     * In diesem Element sind Informationen zu übermitteln, die bei dem Empfang einer als fehlerhaft betrachteten Nachricht möglicherweise der Transportebene entnommen werden konnten. Diese Angaben können gemacht werden, um dem Leser oder Empfänger einer Rücksendenachricht die Identifikation der als fehlerhaft betrachteten und nunmehr zurückgesandten Nachricht zu erleichtern. Alle Kindelemente dieses Elementes sind optional, da keine verbindlichen Anforderungen an das Transportprotokoll gestellt werden können.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungTransportinformationenTypeType $transportinformationen
     * @return self
     */
    public function setTransportinformationen(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungTransportinformationenTypeType $transportinformationen = null)
    {
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungEinzelfallTypeType $nichtVerarbeitbarerEinzelfall
     */
    public function addToNichtVerarbeitbarerEinzelfall(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungEinzelfallTypeType $nichtVerarbeitbarerEinzelfall)
    {
     ...
     * Mit diesem Element werden die nicht verarbeitbaren Einzelfälle aus der zurückgewiesenen (Sammel-)Nachricht kenntlich gemacht. Für jeden nicht verarbeitbaren Einzelfall sind neben den Identifikationsdaten die Gründe mitzuteilen, aufgrund derer der Einzelfall nicht verarbeitet werden konnte. Diese Gründe sind so präzise und vollständig wie möglich zu bezeichnen, um eine schnelle Klärung des Sachverhalts zu ermöglichen.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungEinzelfallTypeType[]
     */
     ...
     * @return self
     */
    public function setIdNachricht(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\IdentifikationNachrichtTypeType $idNachricht = null)
    {
