...
namespace DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\TextFormatiertTypeType;
...
class TextOfficeAnonymousPHPType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeTextOfficeMimeTypeTypeType $textOfficeMimeType
     */
     ...
     * ODF und OOXML sind Rahmenformate, die diverse Subtypen zulassen. Dieses Element steuert die mimeType-Angabe bei, die aussagt, welches Format für die Office-Darstellung im Element textOffice instanziiert ist.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeTextOfficeMimeTypeTypeType
     */
     ...
     * ODF und OOXML sind Rahmenformate, die diverse Subtypen zulassen. Dieses Element steuert die mimeType-Angabe bei, die aussagt, welches Format für die Office-Darstellung im Element textOffice instanziiert ist.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeTextOfficeMimeTypeTypeType $textOfficeMimeType
     * @return self
     */
    public function setTextOfficeMimeType(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeTextOfficeMimeTypeTypeType $textOfficeMimeType)
    {
