...
class AnlagenLinkType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\MetadatenAnlageLinkType[] $anlage
     */
    private $anlage = [
     ...
     */
    public function addToAnlage(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\MetadatenAnlageLinkType $anlage)
    {
        $this->anlage[] = $anlage;
        return $this;
    }
