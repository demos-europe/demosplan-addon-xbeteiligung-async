...
/**
 * Class representing CodeAmtlicherRegionalschluesselType
 *
 ...
 * XSD Type: Code.AmtlicherRegionalschluessel
 */
class CodeAmtlicherRegionalschluesselType extends CodeType
{
}
