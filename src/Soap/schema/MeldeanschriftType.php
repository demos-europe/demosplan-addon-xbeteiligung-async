...
/**
 * Class representing MeldeanschriftType
 *
 ...
 * XSD Type: Meldeanschrift
 */
class MeldeanschriftType
{
    /**
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeGemeindeVZAmtlicherGemeindeschluesselType $gemeindeschluessel
     */
     ...
     * Es ist der vom Statistischen Bundesamt herausgegebene bundeseinheitliche Gemeindeschlüssel der Gemeinde anzugeben, in der die Wohnung liegt.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeGemeindeVZAmtlicherGemeindeschluesselType
     */
     ...
     * Es ist der vom Statistischen Bundesamt herausgegebene bundeseinheitliche Gemeindeschlüssel der Gemeinde anzugeben, in der die Wohnung liegt.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeGemeindeVZAmtlicherGemeindeschluesselType $gemeindeschluessel
     * @return self
     */
    public function setGemeindeschluessel(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeGemeindeVZAmtlicherGemeindeschluesselType $gemeindeschluessel = null)
    {
