...
/**
 * Class representing KodierungFlurstueckTypeType
 *
 * Dieser Typ deckt Informationen zur Identifikation von Flurstücken (Liegenschaftskataster) ab.
 * XSD Type: KodierungFlurstueckType
 */
class KodierungFlurstueckTypeType
{
    /**
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\KodierungFlurstueckTypeType\GemarkungAnonymousPHPType $gemarkung
     */
     ...
     * Durch dieses Elements wird die Gemarkung bezeichnet. Sie ist entweder deskriptiv oder als Nummer dargestellt. Eine Gemarkung ist eine zusammenhängende, aus mehreren Fluren bestehende Fläche des Liegenschaftskatasters.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\KodierungFlurstueckTypeType\GemarkungAnonymousPHPType
     */
     ...
     * Durch dieses Elements wird die Gemarkung bezeichnet. Sie ist entweder deskriptiv oder als Nummer dargestellt. Eine Gemarkung ist eine zusammenhängende, aus mehreren Fluren bestehende Fläche des Liegenschaftskatasters.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\KodierungFlurstueckTypeType\GemarkungAnonymousPHPType $gemarkung
     * @return self
     */
    public function setGemarkung(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\KodierungFlurstueckTypeType\GemarkungAnonymousPHPType $gemarkung)
    {
