...
class RueckweisungType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungsgrundType[] $rueckweisungsgrund
     */
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungsgrundType $rueckweisungsgrund
     */
    public function addToRueckweisungsgrund(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungsgrundType $rueckweisungsgrund)
    {
     ...
     * Jede Instanz dieses Elements enthält Informationen zu einem Fehler bzw. einem Mangel, der in Bezug auf die erhaltene Nachricht identifiziert wurde.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\RueckweisungsgrundType[]
     */
     ...
     * @return self
     */
    public function setIdNachricht(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\IdentifikationNachrichtType $idNachricht)
    {
