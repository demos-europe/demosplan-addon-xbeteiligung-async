...
class AnlagenLinkTypeType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\MetadatenAnlageLinkTypeType[] $anlage
     */
    private $anlage = [
     ...
     */
    public function addToAnlage(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\MetadatenAnlageLinkTypeType $anlage)
    {
        $this->anlage[] = $anlage;
        return $this;
    }
