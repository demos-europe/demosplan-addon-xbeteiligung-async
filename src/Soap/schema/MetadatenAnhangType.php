...
class MetadatenAnhangType
{
    ...
    /**
     * Hashwert der Datei im Anhang. Anhand dieses Wertes kann bei der Übertragung die Integrität der Datei abgesichert werden. Der binäre Hashwert ist in Textform einzutragen als eine Sequenz hexadezimaler Werte (hexadecimal digits). Als Algorithmus für den Hashwert ist SHA2-256 zu verwenden.
     *
