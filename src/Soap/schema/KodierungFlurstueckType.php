...
class KodierungFlurstueckType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\KodierungFlurstueckType\GemarkungAnonymousPHPType $gemarkung
     */
     ...
     * Durch dieses Elements wird die Gemarkung bezeichnet. Sie ist entweder deskriptiv oder als Nummer dargestellt. Eine Gemarkung ist eine zusammenhängende, aus mehreren Fluren bestehende Fläche des Liegenschaftskatasters.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\KodierungFlurstueckType\GemarkungAnonymousPHPType
     */
     ...
     * Durch dieses Elements wird die Gemarkung bezeichnet. Sie ist entweder deskriptiv oder als Nummer dargestellt. Eine Gemarkung ist eine zusammenhängende, aus mehreren Fluren bestehende Fläche des Liegenschaftskatasters.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\KodierungFlurstueckType\GemarkungAnonymousPHPType $gemarkung
     * @return self
     */
    public function setGemarkung(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\KodierungFlurstueckType\GemarkungAnonymousPHPType $gemarkung)
    {
