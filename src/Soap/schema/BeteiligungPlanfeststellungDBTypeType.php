...
/**
 * Class representing BeteiligungPlanfeststellungDBTypeType
 *
 * Komponente der Datentypen, die eine Aufforderung zur Beteiligung beschreiben.
 * XSD Type: BeteiligungPlanfeststellungDBType
 */
class BeteiligungPlanfeststellungDBTypeType
{
    /**
    ...
    /**
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodePlanartPlanfeststellungTypeType $planart
     */
    private $planart = null;

    /**
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeVerfahrensartPlanfeststellungTypeType $verfahrensart
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\MetadatenAnlageLinkTypeType[] $anlagen
     */
     ...
     * Gets as planart
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodePlanartPlanfeststellungTypeType
     */
     ...
     * Sets a new planart
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodePlanartPlanfeststellungTypeType $planart
     * @return self
     */
    public function setPlanart(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodePlanartPlanfeststellungTypeType $planart = null)
    {
     ...
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeVerfahrensartPlanfeststellungTypeType
     */
     ...
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeVerfahrensartPlanfeststellungTypeType $verfahrensart
     * @return self
     */
    public function setVerfahrensart(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeVerfahrensartPlanfeststellungTypeType $verfahrensart = null)
    {
     ...
     * @return self
     */
    public function setZeitraum(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\ZeitraumTypeType $zeitraum = null)
    {
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\MetadatenAnlageLinkTypeType $anlage
     */
    public function addToAnlagen(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\MetadatenAnlageLinkTypeType $anlage)
    {
        $this->anlagen[] = $anlage;
        return $this;
    }
     ...
     * Die für die Beteiligung erforderlichen Anlagen und Verfahrensunterlagen werden in diesem Element referenziert. Für die Übermittlung an die Beteiligungs-DB ist nur die Übermittlung von Links auf Unterlagen zulässig.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\MetadatenAnlageLinkTypeType[]
     */
     ...
     * Die für die Beteiligung erforderlichen Anlagen und Verfahrensunterlagen werden in diesem Element referenziert. Für die Übermittlung an die Beteiligungs-DB ist nur die Übermittlung von Links auf Unterlagen zulässig.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\MetadatenAnlageLinkTypeType[] $anlagen
     * @return self
     */
