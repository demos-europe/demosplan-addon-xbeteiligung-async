...
class VerlinkungTypeType
{
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\VerlinkungTypeType\LinklisteAnonymousPHPType\LinkAnonymousPHPType $link
     */
    public function addToLinkliste(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\VerlinkungTypeType\LinklisteAnonymousPHPType\LinkAnonymousPHPType $link)
    {
        $this->linkliste[] = $link;
        return $this;
    }
     ...
     * Dieses Element steht für eine Liste von verlinkten Angeboten, die vom Autor der Nachricht bereitgestellt werden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\VerlinkungTypeType\LinklisteAnonymousPHPType\LinkAnonymousPHPType[]
     */
     ...
     * Dieses Element steht für eine Liste von verlinkten Angeboten, die vom Autor der Nachricht bereitgestellt werden.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\VerlinkungTypeType\LinklisteAnonymousPHPType\LinkAnonymousPHPType[] $linkliste
     * @return self
     */
