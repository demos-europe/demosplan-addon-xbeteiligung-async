...
/**
 * Class representing PostalischeInlandsanschriftPostfachanschriftType
 *
 ...
 * XSD Type: PostalischeInlandsanschrift.Postfachanschrift
 */
class PostalischeInlandsanschriftPostfachanschriftType
{
    /**
     * @var string $postfach
     */
