...
/**
 * Class representing AkteurRolleType
 *
 * Dieser Typ bezeichnet die Rolle eines am Vorhaben beteiligten Akteurs.
 * XSD Type: AkteurRolle
 */
class AkteurRolleType
{
    /**
     * Angabe der Rolle des Beteiligten.
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeAkteurRolleType $code
     */
    private $code = null;
     ...
     * Angabe der Rolle des Beteiligten.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeAkteurRolleType
     */
     ...
     * Angabe der Rolle des Beteiligten.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeAkteurRolleType $code
     * @return self
     */
    public function setCode(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeAkteurRolleType $code = null)
    {
        $this->code = $code;
        return $this;
    }
