...
/**
 * Class representing NachrichtG2BTypeType
 *
 * Nachrichtenstruktur für die Kommunikation: Behörde ("Government") an Unternehmen ("Business").
 * XSD Type: Nachricht.G2BType
 */
class NachrichtG2BTypeType
{
    /**
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\NachrichtenkopfG2BTypeType $nachrichtenkopfG2B
     */
    private $nachrichtenkopfG2B = null;
    ...
    /**
     * Gets as nachrichtenkopfG2B
     *
     * Dieses Element enthält die Kopfinformationen zu Nachrichten des vorliegenden Typs.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\NachrichtenkopfG2BTypeType
     */
    public function getNachrichtenkopfG2B()
    {
        return $this->nachrichtenkopfG2B;
    }

    /**
     * Sets a new nachrichtenkopfG2B
     *
     * Dieses Element enthält die Kopfinformationen zu Nachrichten des vorliegenden Typs.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\NachrichtenkopfG2BTypeType $nachrichtenkopfG2B
     * @return self
     */
    public function setNachrichtenkopfG2B(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\NachrichtenkopfG2BTypeType $nachrichtenkopfG2B)
    {
        $this->nachrichtenkopfG2B = $nachrichtenkopfG2B;
        return $this;
    }
}
