...
class VerlinkungType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\VerlinkungType\LinklisteAnonymousPHPType\LinkAnonymousPHPType[] $linkliste
     */
     ...
     */
    public function addToLinkliste(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\VerlinkungType\LinklisteAnonymousPHPType\LinkAnonymousPHPType $link)
    {
        $this->linkliste[] = $link;
        return $this;
    }
     ...
     * Dieses Element steht für eine Liste von verlinkten Angeboten, die vom Autor der Nachricht bereitgestellt werden.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\VerlinkungType\LinklisteAnonymousPHPType\LinkAnonymousPHPType[] $linkliste
     * @return self
     */
