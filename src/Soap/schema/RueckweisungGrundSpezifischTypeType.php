...
/**
 * Class representing RueckweisungGrundSpezifischTypeType
 *
 ...
 * XSD Type: Rueckweisung.GrundSpezifischType
 */
class RueckweisungGrundSpezifischTypeType
{
    /**
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFehlercodeSpezifischTypeType $fehlercode
     */
     ...
     * In diesem Element wird ein Fehlercode übermittelt. Die zugrundeliegende Schlüsseltabelle muss mit der listURI (bspw. urn:de:bund:bzst:schluessel:rts.fehlercodes) und listVersionID (bspw. 2016-01-19) identifiziert werden.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFehlercodeSpezifischTypeType
     */
     ...
     * In diesem Element wird ein Fehlercode übermittelt. Die zugrundeliegende Schlüsseltabelle muss mit der listURI (bspw. urn:de:bund:bzst:schluessel:rts.fehlercodes) und listVersionID (bspw. 2016-01-19) identifiziert werden.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFehlercodeSpezifischTypeType $fehlercode
     * @return self
     */
    public function setFehlercode(?\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFehlercodeSpezifischTypeType $fehlercode = null)
    {
