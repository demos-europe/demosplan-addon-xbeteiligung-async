...
class NameNatuerlichePersonTypeType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\AllgemeinerNameTypeType $familienname
     */
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\AllgemeinerNameTypeType $vorname
     */
     ...
     * Der Familienname ist der aktuelle Nachname einer Person und Ausdruck einer bestimmten Familienzugehörigkeit dieser Person.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\AllgemeinerNameTypeType
     */
     ...
     * Der Familienname ist der aktuelle Nachname einer Person und Ausdruck einer bestimmten Familienzugehörigkeit dieser Person.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\AllgemeinerNameTypeType $familienname
     * @return self
     */
    public function setFamilienname(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\AllgemeinerNameTypeType $familienname)
    {
     ...
     * Der Vorname ist der Name bzw. der Teil des Namens, der nicht die Zugehörigkeit zu einer Familie ausdrückt, sondern das Individuum innerhalb der Familie bezeichnet und dazu dient, es von anderen Familienmitgliedern zu unterscheiden.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\AllgemeinerNameTypeType $vorname
     * @return self
     */
    public function setVorname(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\AllgemeinerNameTypeType $vorname)
    {
