...
namespace DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\BefundlisteFormellType;
...
class BefundAnonymousPHPType
{
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFormelleBefundeArtType $artDesBefundes
     */
     ...
     * In diesem Element wird die Befundkategorie angegeben, der dieser Befund zugeordnet werden kann.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFormelleBefundeArtType
     */
     ...
     * In diesem Element wird die Befundkategorie angegeben, der dieser Befund zugeordnet werden kann.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFormelleBefundeArtType $artDesBefundes
     * @return self
     */
    public function setArtDesBefundes(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeFormelleBefundeArtType $artDesBefundes)
    {
