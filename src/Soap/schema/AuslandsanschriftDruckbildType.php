...
/**
 * Class representing AuslandsanschriftDruckbildType
 *
 ...
 * XSD Type: Auslandsanschrift.Druckbild
 */
class AuslandsanschriftDruckbildType
{
    /**
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeZielstaatType $staat
     */
    private $staat = null;
     ...
     *
     * @var \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\ZeileAufschriftType[] $anschriftzone
     */
     ...
     * Hier ist Staatenschlüssel des Zielstaats aus der aktuell gültigen Staats- und Gebietssystematik des Statistischen Bundesamtes zu übermitteln. Da mit dem Datentyp Auslandsanschrift.Druckbild nur Auslandsanschriften übermittelt werden dürfen, ist die Verwendung des Schlüssels 000 (Deutschland) nicht zulässig.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeZielstaatType
     */
     ...
     * Hier ist Staatenschlüssel des Zielstaats aus der aktuell gültigen Staats- und Gebietssystematik des Statistischen Bundesamtes zu übermitteln. Da mit dem Datentyp Auslandsanschrift.Druckbild nur Auslandsanschriften übermittelt werden dürfen, ist die Verwendung des Schlüssels 000 (Deutschland) nicht zulässig.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeZielstaatType $staat
     * @return self
     */
    public function setStaat(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\CodeZielstaatType $staat)
    {
        $this->staat = $staat;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\ZeileAufschriftType $zeileAnschrift
     */
    public function addToAnschriftzone(\DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\ZeileAufschriftType $zeileAnschrift)
    {
     ...
     * Hier sind zeilenweise die für die Zustellung erforderlichen Angaben zur Anschriftzone zu übermitteln.
     *
     * @return \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\ZeileAufschriftType[]
     */
     ...
     * Hier sind zeilenweise die für die Zustellung erforderlichen Angaben zur Anschriftzone zu übermitteln.
     *
     * @param \DemosEurope\DemosplanAddon\XBeteiligung\Soap\schema\ZeileAufschriftType[] $anschriftzone
     * @return self
     */
