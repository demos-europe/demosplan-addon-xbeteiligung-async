...
class Version20260203162559 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'DPLAN-17248: Create table that holds ids of external system which are relevant for our procedures';
    }
